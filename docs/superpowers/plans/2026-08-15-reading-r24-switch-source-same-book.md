...
- [x] Task 7: 换源候选展示目录章节数（fetchToc 异步获取，「共 N 章」），详情页目录标题显示章节数
- [x] Task 8: 测试（换源面板 author props、详情页书名保持、候选列表书名统一、同源去重、精确匹配优先、目录章节数展示）
- [x] Task 9: 全量 `npm test`、`npm run build`、提交
